...
exports.formatMigrationPlan = formatMigrationPlan;
const promises_1 = __importDefault(require("node:fs/promises"));
const node_path_1 = __importDefault(require("node:path"));
/**
 * Analyze existing codebase structure for migration planning.
 */
async function analyzeCodebase(projectRoot) {
    const analysis = {
        hasTests: false,
        hasLinting: false,
        hasTypeScript: false,
    ...
    try {
        ...
        try {
            ...
            for (const file of components.slice(0, 20)) { // Limit to first 20 files
                try {
                    const content = await promises_1.default.readFile(node_path_1.default.join(srcDir, file), "utf-8");
 ...
 */
async function generateMigrationPlan(projectRoot, graph) {
    ...
    return {
        projectId: node_path_1.default.basename(projectRoot),
