...
exports.validateScopeLock = validateScopeLock;
exports.validateActualChangesAgainstScope = validateActualChangesAgainstScope;
exports.summarizeViolations = summarizeViolations;
exports.detectScopeOverlaps = detectScopeOverlaps;
 ...
 */
function validateScopeLock(changedFiles, lock) {
    const violations = [];
    for (const file of changedFiles) {
        ...
        if (lock.allowed_paths.length > 0 &&
 ...
 */
function validateActualChangesAgainstScope(changes, lock) {
    return validateScopeLock(changes.map((c) => c.file), lock);
}
/**
 ...
 */
function detectScopeOverlaps(locks) {
    const overlaps = [];
